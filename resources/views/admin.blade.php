    ...
    <div class="flex min-h-screen">
        <aside class="w-64 bg-[#0F172A] flex flex-col p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white transition-all font-medium mt-4">
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div class="bg-white p-6 rounded-[1.5rem] border border-gray-100 shadow-sm">
                        ...
                        <div class="text-4xl font-bold text-slate-800 mb-3">1</div>
                    ...
                    <div class="bg-white p-6 rounded-[1.5rem] border border-gray-100 shadow-sm">
                        ...
                        <div class="text-4xl font-bold text-slate-800 mb-3">0</div>
                    ...
                    <div class="bg-white p-6 rounded-[1.5rem] border border-gray-100 shadow-sm">
                        ...
                        <div class="text-4xl font-bold text-rose-500 mb-3">0</div>
                ...
                <div class="bg-white rounded-[1.5rem] border border-gray-100 shadow-sm overflow-hidden">
                    <div class="p-6 flex justify-between items-center">
                        ...
                        <div class="flex gap-2">
                            <input type="text" placeholder="Rechercher un email..." class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 w-64">
                            <button class="bg-[#0F172A] text-white p-2 rounded-lg w-10 h-10 flex items-center justify-center">
                    ...
                    <div class="px-6 pb-6">
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <tr class="group hover:bg-gray-50/50 transition-colors">
                                    <td class="py-6 text-xs text-slate-300 font-medium">#0003</td>
                                    <td class="py-6 font-bold text-slate-700">admin</td>
                                    <td class="py-6 text-sm text-slate-400 italic">admin@mailinator.com</td>
                                    <td class="py-6 text-center">
                                        <span class="text-emerald-500 font-bold text-sm">0 pts</span>
                                    </td>
                                    <td class="py-6">
                                        <div class="flex items-center justify-center gap-2">
                                            <div class="w-2 h-2 rounded-full bg-emerald-500"></div>
                                            <span class="text-emerald-500 font-bold text-xs italic">Actif</span>
                                        </div>
                                    </td>
                                    <td class="py-6 text-right">
                                        <button class="bg-gray-100 text-slate-400 text-[10px] font-black uppercase px-4 py-1.5 rounded-md hover:bg-gray-200 transition-all">
                                            Protégé
                                        </button>
                                    </td>
                                </tr>
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-50">
                            <div class="text-[10px] font-black text-slate-300 uppercase">Affichage de 1 utilisateurs</div>
                        </div>
                    </div>
                </div>
            </div>
